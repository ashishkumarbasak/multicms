...
--
-- Host: localhost
-- Generation Time: Feb 17, 2014 at 05:02 PM
...
--
-- Table structure for table `trv_features`
--

CREATE TABLE `trv_features` (
  `feature_id` int(11) NOT NULL AUTO_INCREMENT,
  `feature_title` varchar(255) NOT NULL,
  `feature_code` varchar(255) NOT NULL,
  `feature_description` text,
  `language_id` int(11) NOT NULL,
  `m_ref_feature_id` int(11) NOT NULL,
  PRIMARY KEY (`feature_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4 ;

--
-- Dumping data for table `trv_features`
--

INSERT INTO `trv_features` (`feature_id`, `feature_title`, `feature_code`, `feature_description`, `language_id`, `m_ref_feature_id`) VALUES
(1, 'Feature 1', '', 'Feature 1', 1, 1),
(2, 'Feature english 1', '', 'Feature english 1', 2, 2),
(3, 'Feature english 2', '', 'Feature english 2', 2, 3);
...
(2, 'Package English 1', 'pack1001', '', 2, 2),
(3, 'Package English 2', 'pack1002', '', 2, 3);
...
(1, 'pages_default_product_list.php', 0, '0', 'Linea Ospedaliera', '', '', '', 'linea-ospedaliera', '', 'Description 1 [Italian]', '', 'Description 2 [Italian]', '', '2013-10-09 16:10:26', 'published', 'admin', 7, 1, 1),
(11, 'pages_default_homepage.php', 0, '1', 'Home', '', '', '', 'home', '', 'dadasasd', '', 'sdadsa', '', '2013-11-07 09:11:03', 'published', 'admin', 1, 5, 5),
(12, 'pages_default_product_list.php', 0, '0', 'Irrigatori Meccanici', '', '', '', 'irrigatori-meccanici', '', '', '', '', '', '2013-11-07 10:11:27', 'published', 'admin', 9, 1, 12),
(13, 'pages_default_product_list.php', 12, '0', 'ACTEON GROUP-SATELEC', '', '', '', 'acteon-group-satelec', '', '', '', '', '', '2013-11-07 10:11:38', 'published', 'admin', 9.1, 1, 13),
(15, 'pages_default.php', 0, '0', 'Chi siamo', '', '', '', 'chi-siamo', '', '', '', '', '', '2013-11-07 10:11:08', 'published', 'admin', 6, 1, 15),
(16, 'pages_default_contatto.php', 0, '0', 'Contatto', '', '', '', 'contatto', '', '', '', '', '', '2013-11-07 11:11:10', 'published', 'admin', 8, 1, 16),
...
(20, 'pages_default.php', 0, '1', 'Home', '', '', '', 'home', '', 'dsadsddsa', '', '', '', '2013-11-10 14:11:03', 'published', 'admin', 1, 1, 20),
(21, 'pages_default.php', 0, '0', 'Page 1', '', '', '', 'test-page-by-me', '', '', '', '', '', '2013-11-10 14:11:37', 'published', 'admin', 2, 1, 21),
(25, 'pages_default.php', 0, '0', 'Поткатегории', '', '', '', 'Поткатегории', '', '', '', '', '', '2013-11-11 05:11:54', 'published', 'admin', 3, 1, 25),
(100, 'pages_default.php', 0, '0', 'Mother Page', '', '', '', 'mother-page-level-1', '', '', '', '', '', '2013-11-28 23:11:19', 'published', 'admin', 4, 1, 100),
(101, 'pages_default.php', 100, '0', 'Child Page - Level 2', '', '', '', 'child-page-level-2', '', '', '', '', '', '2013-11-28 23:11:52', 'published', 'admin', 4.1, 1, 101),
(102, 'pages_default.php', 101, '0', 'Child Page - Level 3', '', '', '', 'child-page-level-3', '', '', '', '', '', '2013-11-28 23:11:49', 'published', 'admin', 4.2, 1, 102),
(103, 'products.php', -1, '0', 'Test product italian 1', '', '', '', 'test-product-italian-1', 'x.pjg', 'test product italian description', '', '', '', '2013-11-29 13:11:48', 'published', 'admin', NULL, 1, 103),
...
(140, 'pages_default.php', 0, '0', 'Dove siamo', '', '', '', 'dove-siamo', '', 'Dove Siamo', '', '', '', '2014-02-12 10:02:51', 'published', 'admin', 5, 1, 140),
(141, 'products.php', -1, '0', 'Test product english 1', '', '', '', 'test-product-english-1', '', 'Dolorer ehenis idisitae pro corerro estis accullandent quia volorum aut que voles adigeniet velestiatem a si alia cum volupta tempore iusam, sedit earum, simagnam quae veliquamEverumquo tet faciis eseniatur am dolluptius adis delibus reperferem unt modionecto etur magnimp orumquae sunt.repudis molupta simaio iusa quam net etur, od quas perion eatur aribusae. Riam re, neceperspiet laccabo reicit aut liatiunt qui cumet quam volorerro tet lat ut modignianda quodi', '', '', '', '2014-02-17 09:02:17', 'published', 'admin', NULL, 2, 103),
(142, 'pages_default.php', 0, '0', 'Поткатегории', '', '', '', 'n-a', '', 'Поткатегории English', '', '', '', '2014-02-17 09:02:47', 'published', 'admin', 2, 2, 25),
(143, 'pages_default.php', 0, '1', 'Home', '', '', '', 'home', '', 'Home Page', '', '', '', '2014-02-17 09:02:28', 'published', 'admin', 1, 2, 20);
...
--
-- Table structure for table `trv_product_features`
--

CREATE TABLE `trv_product_features` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) NOT NULL,
...
--
-- Dumping data for table `trv_product_features`
--

INSERT INTO `trv_product_features` (`id`, `product_id`, `feature_id`, `language_id`, `feature_value`) VALUES
(9, 1, 1, 1, '    Feature 1 value    '),
(12, 37, 2, 2, ' Feature english 1 value '),
(13, 37, 3, 2, ' Feature english 2 value ');
...
(17, 1, 1, 1, '200gM'),
(18, 1, 1, 1, '300gM'),
(23, 37, 3, 2, 'Pack Value english 1'),
(24, 37, 3, 2, 'Pack value english 2');
