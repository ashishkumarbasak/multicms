                    ...
                    <table class="standard-table">
                        ...
                        <tr>
                            ...
                            <td>
                            		...
                            		<a target="_blank" href="<?php echo base_url();?>assets/documents/<?php echo $value->document_file_name; ?>">
										<?php echo $value->document_name; ?> (<?php echo $file_type; ?>)
                                	</a>
                           	</td>

                            <td width="100px">
                            	
                            		<a target="_blank" href="<?php echo base_url();?>assets/documents/<?php echo $value->document_file_name; ?>" class="button small white">
                                		download
                                	</a>
				...
				<div class="large-notice">
                    ...
                    <ul class="links-list">
                    	...
                    	<?php foreach($rootcategories as $key=>$value){ ?>
							...
							<li><a href="<?php echo base_url(); ?><?php echo CURRENT_LANGUAGE."/";?>download/category/<?php echo $value->category_id; ?>/page/1"><?php echo $value->category_name; ?></a></li>
