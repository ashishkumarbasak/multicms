    ...
    <div class="clearfix-small"></div>
		...
		<div class="twelve columns">
                            ...
                            <?php if(isset($profile_details) && ($profile_details->user_type==1 || $profile_details->user_type==3)) { ?>
                                <li><a href="<?php echo base_url();?><?php echo $this->config->item('dashboard_url');?>"><?php echo lang('struttura_profilo');?></a></li>
                                <li class="active"><a href="javascript:void(0);"><?php echo lang('struttura_descrizione');?></a></li>
                                <!-- 
            ...
            <div class="tab_container">
                    <div id="tab1" class="tab_content">
                            ...
                            <div class="tab-content">	
								<div class="padding">
									<form id="profile_edit_form2" style="width:660px;" name="profile-edit-form" method="post" action="<?php echo base_url();?><?php echo $this->config->item('save_descrizione_url');?>">
										<?php echo $this->template->block('Descrizione','profile/hotel_profile_form_parts/Descrizione.php');?>
									</form>        
								</div>
