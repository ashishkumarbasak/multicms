    ...
    <div class="clearfix-small"></div>
		...
		<div class="twelve columns">
                            ...
                            <?php if(isset($profile_details) && ($profile_details->user_type==1 || $profile_details->user_type==3)) { ?>
                                ...
                                //-->
                                <li class="active"><a href="javascript:void(0);"><?php echo lang('struttura_Immagini');?></a></li>
                            <?php } else { ?>   
            ...
            <div class="tab_container">
                    <div id="tab1" class="tab_content">
                        ...
                        <div class="tab-content">	
							<div class="padding">
								<?php echo $this->template->block('Immagini','profile/hotel_profile_form_parts/Immagini.php');?>
							</div>
