...
<div class="container">
		...
		<div class="padding">
			...
			<div class="clearfix-big"></div>
                    	...
                    	<?php echo $offer_details->offer_package_description;?>
            		 	...
            		 	<div id="mapCanvas" style="width:660px; height:250px ;float:left;"></div>
  ...
  <ul class="the-icons">
        <li><strong><?php echo $offer_details->offer_price_adult;?> &euro;</strong> / <?php echo lang('adults');?> </li>
        <li><strong><?php echo $offer_details->offer_price_children;?> &euro;</strong> / <?php echo lang('children');?></li>
            <li><em><?php echo lang('duration_time');?> </em><br><?php echo $offer_details->offer_duration;?></li>
                        <li><em><?php echo lang('offer_includes');?> </em><br><?php echo $offer_details->offerinclude_option;?></li>

        <li><em><?php echo lang('offer_validation');?></em><br><?php echo date("d/m/Y",strtotime($offer_details->offer_start_date));?> - <?php echo date("d/m/Y",strtotime($offer_details->offer_finish_date));?></li>
