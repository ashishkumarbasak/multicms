...
<div class="four columns background">
			...
			<div class="dashboard_item background">
				<h3><?php echo lang('edit-offer');?></h3>
			...
			<div class="padding">	
				...
				<form id="add_new_lastminute_offer" style="width:660px;" name="add_new_lastminute_offer" method="post" action="" enctype="multipart/form-data">
					...
					<input type="text" name="offer_title" id="offer_title" class="input-big" value="<?php if(isset($offer_details)) echo $offer_details->offer_title;?>" />
                    ...
                    <select name="offer_duration" id="offer_duration" style="width: 205px !important;">
                    	<?php foreach($options as $key=>$value) { ?>
                        	<option value="<?php echo $value;?>" <?php if(isset($offer_details) && $offer_details->offer_duration==$value) { ?> selected="selected" <?php } ?>><?php echo $value;?></option>
                        <?php } ?>
                    </select>
					<div class="clearfix"></div>
					...
					<input type="text" name="offer_availability" id="offer_availability" class="input-big"  value="<?php if(isset($offer_details)) echo $offer_details->offer_availability;?>" />
					<div class="clearfix"></div>
                    </div>
					...
					<input type="text" name="offer_start_date" id="offer_start_date" class="input-big text date_picker" value="<?php if(isset($offer_details)) echo $offer_details->offer_start_date;?>" />
					<div class="clearfix"></div>
					...
					<input type="text" name="offer_finish_date" id="offer_finish_date" class="input-big text date_picker" value="<?php if(isset($offer_details)) echo $offer_details->offer_finish_date;?>" />
					<div class="clearfix"></div>
					</div>
  ...
  <label class="padding_top_7"><?php echo lang('offer_includes');?></label>
					<select name="offer_included" id="offer_included">
                    	<?php if(!empty($offer_include_options) && is_array($offer_include_options))
								foreach($offer_include_options as $oip_key=>$option){ ?>
									<option  <?php if(isset($offer_details) && $offer_details->offer_included==$option->offerincludeoption_id) echo 'selected="selected"'; ?> value="<?php echo $option->offerincludeoption_id;?>"><?php echo $option->offerinclude_option;?></option>
                    	<?php 	} ?>
                    </select>
					<div class="clearfix"></div>
                    ...
                    <input type="text" name="offer_end_price" id="offer_end_price" class="input-big"  value="<?php if(isset($offer_details)) echo $offer_details->offer_end_price;?>" />
					<div class="clearfix"></div>
                    </div>
				
					<label class="padding_top_13"><?php echo lang('price_adult');?></label>
					...
					<label class="padding_top_13"><?php echo lang('price_children');?></label>
					...
					<textarea class="input-big" name="offer_package_description_it" id="offer_package_description_it" style="margin:0px; padding:0px;"/><?php if(isset($offer_details)) echo $offer_details->offer_package_description_it;?></textarea>					                    <div class="clearfix-big"></div>
					...
					<textarea class="input-big" name="offer_package_description_en" id="offer_package_description_en" style="margin:0px; padding:0px;"/><?php if(isset($offer_details)) echo $offer_details->offer_package_description_en;?></textarea>					                    <div class="clearfix-big"></div>
					...
					<textarea class="input-big" name="offer_package_description_fr" id="offer_package_description_fr" style="margin:0px; padding:0px;"/><?php if(isset($offer_details)) echo $offer_details->offer_package_description_fr;?></textarea>
					                    <div class="clearfix-big"></div>
					...
					<textarea class="input-big" name="offer_package_description_de" id="offer_package_description_de" style="margin:0px; padding:0px;"/><?php if(isset($offer_details)) echo $offer_details->offer_package_description_de;?></textarea>					                    <div class="clearfix-big"></div>
					...
					<textarea class="input-big" name="offer_package_description_es" id="offer_package_description_es" style="margin:0px; padding:0px;"/><?php if(isset($offer_details)) echo $offer_details->offer_package_description_es;?></textarea>					                    <div class="clearfix-big"></div>
                	...
                	<li><input type="checkbox" class="checkbox" name="offer_facilities[]" id="offer_facilities_<?php echo $service_key; ?>" value="<?php echo $service->facility_id;?>" <?php if(isset($existence_offer_services) && in_array($service->facility_id,$existence_offer_services)) {?> checked="checked" <?php }?> /> <?php echo $service->facility_name;?></li>
               		<?php } ?>
					</ul>
                	...
                	<li><input type="checkbox" class="checkbox" name="offer_themes[]" id="offer_themes_<?php echo $theme_key; ?>" value="<?php echo $LastminuteTheme->lastminutetheme_id;?>" <?php if(isset($existence_offer_themes) && in_array($LastminuteTheme->lastminutetheme_id,$existence_offer_themes)) {?> checked="checked" <?php }?> /> <?php echo $LastminuteTheme->theme_name;?></li>
                	<?php } ?>
					</ul>
                	...
                	<li><input type="checkbox" class="checkbox" name="offer_periods[]" id="offer_periods_<?php echo $offer_period_key; ?>" value="<?php echo $OfferPeriod->period_id;?>" <?php if(isset($existence_offer_periods) && in_array($OfferPeriod->period_id,$existence_offer_periods)) {?> checked="checked" <?php }?> /> <?php echo $OfferPeriod->period_name;?></li>
                	<?php } ?>
					</ul>
					...
					if($existence_offer_attachments!=NULL)
					foreach($existence_offer_attachments as $key=>$item){
						$file_source = OFFER_ATTACHMENT_FILE_PATH_FOR_AVATAR .$item->offer_id."/".$item->image_name;
						echo "<li id='existing_attachment_".$item->offersattachment_id."'>".image_thumb($file_source,48,48)."<a href='javascript:void(0);' onclick='DeleteOfferAttachment(".$item->offersattachment_id.",".$offer_id.");'>Delete</a></li>";
					}
					?>
