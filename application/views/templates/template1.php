...
<div class="two-thirds column">
	...
	<div class="portfolio-item-meta">
		<h1 class="headline"><?php echo $page_title; ?></h1>
			...
			<h4><?php echo $additional_title[0]; ?></h4>
			<h4><?php echo $additional_title[1]; ?></h4>
			<h4><?php echo $additional_title[2]; ?></h4>
			<h4></h4>
	...
	<p><?php echo $additional_description[0]; ?>
        	<?php echo $additional_description[1]; ?></p>
        	
                	<?php echo $additional_photo[0]; ?></p>
	                	<?php echo $additional_photo[1]; ?></p>
...
<div class="one-third column">
		...
		<div class="large-notice" style="height:160px;">
			<h4><?php echo $additional_title[3]; ?></h4>
