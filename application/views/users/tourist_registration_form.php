<form id="login" method="post" action="">
                    ...
                    <?php if($invitation_code!=NULL && $account_type=="1") { ?>
                    					...
                    					<h5 style="margin-bottom:6px;">Richiedi il codice di accesso gratuito per 2 mesi gratis  <a href="http://travelly.me/users/invitation">qui &raquo;</a></h5>
			...
			<span class="suggestion" id="invitation_codeInfo"></span>
                        ...
                        <div class="clearfix"></div>
                        <a href="http://travelly.me/users/invitation" class="button medium red">Clicca adesso qui per richiedere il tuo codice&raquo;</a><br>
                        <div class="clearfix-small"></div>
                        Se non hai ricevuto il codice invia una mail a <a href="mailto:support@travelly.me">support@travelly.me</a>
                        <div class="clearfix-small"></div>
