...
class Template {
	...
	{	
		...
		$this->set('site_description', $this->ci->config->item('OCU_site_description'));
		$this->set('site_keywords', $this->ci->config->item('OCU_site_keywords'));
...
function check_menu_is_current($item='')
{
	$ci =& get_instance();
...
function check_sub_menu_is_current($item='')
{
	$ci =& get_instance();
