...
class Myvalidation
{
	...
	function validate_invitation_code(){
		...
		if(!$this->obj->Invitation->check_invitation_code($this->data) && $this->data['invitation_code']!="PROMO4FREE2MON")
	...
	function validate_hotel_profile(){
		...
		$this->data['root_category']=$this->obj->input->post('root_category');
		$this->data['sub_category']=$this->obj->input->post('sub_category');
