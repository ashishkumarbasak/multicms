...
|
*/
$config['OCU_site_name'] = "It Link - Consulenza informatica, partner di SAP";
$config['OCU_site_description'] = "It Link: societ&agrave; di consulenza informatica, partner di SAP. Sw e soluzioni per le aziende. Sviluppo di progetti ed erogazione di servizi in area ERP, CRM, Business Intelligence, SCM, MII. Vendita di licenze SAP.";
$config['OCU_site_keywords'] = "sap, erp, manufacturing, mii, crm, business intelligence, bi, consulenza informatica, it-link, sw, sw aziendali, sw gestionale, business object, sap var, sw produzione, application management, system management, consulenza sap, it link, itlink, it_link, bo, netweaver";
