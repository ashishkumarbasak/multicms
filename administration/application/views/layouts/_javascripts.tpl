    ...
    <script src="{$baseurl}assets/bootstrap/js/jquery.js"></script>
    <script src="{$baseurl}assets/bootstrap/js/google-code-prettify/prettify.js"></script>
    <script src="{$baseurl}assets/bootstrap/js/bootstrap-transition.js"></script>
    <script src="{$baseurl}assets/bootstrap/js/bootstrap-alert.js"></script>
    <script src="{$baseurl}assets/bootstrap/js/bootstrap-modal.js"></script>
    <script src="{$baseurl}assets/bootstrap/js/bootstrap-dropdown.js"></script>
    <script src="{$baseurl}assets/bootstrap/js/bootstrap-scrollspy.js"></script>
    <script src="{$baseurl}assets/bootstrap/js/bootstrap-tab.js"></script>
    <script src="{$baseurl}assets/bootstrap/js/bootstrap-tooltip.js"></script>
    <script src="{$baseurl}assets/bootstrap/js/bootstrap-popover.js"></script>
    <script src="{$baseurl}assets/bootstrap/js/bootstrap-button.js"></script>
    <script src="{$baseurl}assets/bootstrap/js/bootstrap-collapse.js"></script>
    <script src="{$baseurl}assets/bootstrap/js/bootstrap-carousel.js"></script>
    <script src="{$baseurl}assets/bootstrap/js/bootstrap-typeahead.js"></script>
    <script src="{$baseurl}assets/bootstrap/js/bootstrap-affix.js"></script>
    <script src="{$baseurl}assets/bootstrap/js/application.js"></script>
    
    
	<script type="text/javascript" src="http://code.jquery.com/jquery-1.5.2.js"></script>

	<script src="{$baseurl}assets/bootstrap/js/wysihtml5-0.3.0.js"></script>
	...
	<script src="{$baseurl}assets/bootstrap/js/bootstrap-wysihtml5.js"></script>
...
{/literal}
<script src="{$baseurl}assets/js/jquery.form.min.js"></script>
{literal}
<script type="text/javascript">
...
<script src="{$baseurl}assets/js/langpicker.js"></script> 