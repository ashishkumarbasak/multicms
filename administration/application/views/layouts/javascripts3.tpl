...
<script src="{$baseurl}assets/js/jQuery-File-Upload/js/main3.js"></script>
...
$(function() {
    ...
    stop: function (event, ui) {
			...
			$.ajax({
				data: data,
				type: 'POST',
				url: '{/literal}{$baseurl}{literal}manage/pages/edit/{/literal}{$page_id}{literal}/page_videos/saveorder'
			});
