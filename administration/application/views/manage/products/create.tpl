				...
				<h1>Add Product</h1>
                        ...
                        <div class="tab-content">
                            ...
                            <tr>
                                ...
                                <td>
                                	<input name="page_title" type="text" class="text small" id="page_title" value="{if isset($page_title)}{$page_title}{/if}" />
                            ...
                            <tr>
                                ...
                                <td>
                                	<input type="text" name="page_url" style="text-transform: lowercase;" class="text small" id="page_url" value="{if isset($page_url)}{$page_url}{/if}" />
