		...
		<div class="block withsidebar">
				...
				<div class="block_content">
                    ...
                    <form action="" method="post">	
                    	{if isset($user_updated_successfully)}
						...
						<table cellpadding="0" cellspacing="0" width="100%" class="sortable margin">
							...
							<tbody>
								<tr>
									...
									<td><input type="text" class="text small" name="full_name" value="{$user_details->display_name}" /></td>
									<td><a href="#" class="tooltip-test" title="Tooltip"><i class="icon-info-sign"></i></a></td>
								</tr>
								
								<tr>
									<td><label>Username:</label></td>
									<td><input type="text" class="text small" name="signup_username" value="{$user_details->username}"/></td>
									<td><a href="#" class="tooltip-test" title="Tooltip"><i class="icon-info-sign"></i></a></td>
								</tr>
								
								<tr>
									<td><label>Email:</label></td>
									<td><input type="text" class="text small" name="email"  value="{$user_details->email}"/></td>
									<td><a href="#" class="tooltip-test" title="Tooltip"><i class="icon-info-sign"></i></a></td>
								</tr>
