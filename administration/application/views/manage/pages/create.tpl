				...
				<h1>Add page</h1>
                        ...
                        <div class="tab-content">
                            ...
                            <tr>
                                ...
                                <td>
                                	<input name="page_title" id="page_title" type="text" class="text small" value="{if isset($page_title)}{$page_title}{/if}" />
                            ...
                            <tr>
                                ...
                                <td>
                                	<input type="text" name="page_url" id="page_url" style="text-transform: lowercase;" class="text small" value="{if isset($page_url)}{$page_url}{/if}" />
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%" class="sortable">
                                                        <tbody>
                                                            {foreach from=$list_of_menus item=menu name=listofpages key=pk}
                                                                <tr>
                                                                    <td width="3%">
                                                                        <input type="checkbox" name="menu_ids[]" id="page_included_{$menu->menu_id}" value="{$menu->menu_id}" />
                                                                    </td>
