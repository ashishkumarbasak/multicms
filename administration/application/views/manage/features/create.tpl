	...
	<div class="wrapper">		
		<div class="block">
			<div class="block_content">
				<h1>Add Features</h1>
                		{if isset($feature_create_successfully)}
                        ...
                        <div class="tab-content">
                            ...
                            <tr>
                                ...
                                <td>
                                	<input name="feature_title" type="text" class="text small" id="feature_title" value="{if isset($feature_title)}{$feature_title}{/if}" />
                                </td>
                            </tr>
                        </table>    
                                         ...
                                         <table cellpadding="0" cellspacing="0" width="100%" class="sort">
                                            <tr>
                                                ...
                                                <td>
                                                	<textarea class="textarea" name="feature_description">{if isset($feature_description)}{$feature_description}{/if}</textarea>
