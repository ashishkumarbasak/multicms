		...
		<div class="block">
			<div class="block_content">
				<h1>Edit Packaging</h1>
                		{if isset($package_update_successfully)}
                        	<div class="message info">
                            <p>
                            	Packaging Update Successfully.
                            </p>
                            </div>
                        {/if}
                        ...
                        <div class="tab-content">
                            ...
                            <tr>
                                ...
                                <td>
                                	<input name="packaging_title" type="text" class="text small" id="packaging_title" value="{if isset($packaging_title)}{$packaging_title}{else}{$packaging_details->pack_title}{/if}" />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                	<input type="text" name="packaging_code" style="text-transform: lowercase;" class="text small" id="packaging_code" value="{if isset($packaging_code)}{$packaging_code}{else}{$packaging_details->pack_code}{/if}" />
                                </td>
                            </tr>
                        </table>    
                                         ...
                                         <table cellpadding="0" cellspacing="0" width="100%" class="sort">
                                            <tr>
                                                ...
                                                <td>
                                                	<textarea class="textarea" name="packaging_description">{if isset($packaging_description)}{$packaging_description}{else}{$packaging_details->pack_description}{/if}</textarea>
