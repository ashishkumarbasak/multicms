					...
					<form action="" method="post" enctype="multipart/form-data">
						...
						<table cellpadding="0" cellspacing="0" width="100%" class="sortable">	
							...
							<tr>
								...
								<td>
                                	<input name="page_title" type="text" id="page_title" class="text small" value="{if isset($page_title)}{$page_title}{else}{$page_details->page_title}{/if}" />
							...
							<tr>
								...
								<td>
                                	<input type="text" name="page_url" id="page_url" style="text-transform: lowercase;" class="text small" value="{if isset($page_url)}{$page_url}{else}{$page_details->page_url}{/if}" />
