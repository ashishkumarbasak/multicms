						...
						<table cellpadding="0" cellspacing="0" width="100%" class="sortable margin">
							...
							<tbody>
								<tr>
									...
									<td><input type="text" class="text small" name="video_title_fr" value="{if $video_details!=NULL}{$video_details->video_title_fr}{/if}" /></td>
								...
								<tr>
									...
									<td><textarea name="video_description_fr" id="video_description" class="textarea">{if $video_details!=NULL}{$video_details->video_description_fr}{/if}</textarea></td>
									<td><a href="#" class="tooltip-test" title="Tooltip"><i class="icon-info-sign"></i></a></td>
								</tr>
									...
									<td>
                                    	<div class="container">
                                            ...
                                            {if $video_details!=NULL}
                                            	{if $video_details->video_image_name_fr!=NULL}
                                                	<div class="files">
                                                    <a href="{$baseurl|replace:"administration/":""}assets/videos/{$video_details->video_image_name_fr}" target="_blank">														{$video_details->video_image_name_fr}
                                                    </a> [<a href="{$baseurl}manage/videos/delete_video_image/{$video_details->trv_video_id}/fr">Delete</a>]
                                                    </div>
                                                {/if}
                                            {/if}                                              
                                        </div>
								 ...
								 <tr>
									...
									<td>
                                    	<div class="container">
                                            ...
                                            {if $video_details!=NULL}
                                            	{if $video_details->attachment_fr!=NULL}
                                                	<div class="files">
                                                    <a href="{$baseurl|replace:"administration/":""}assets/videos/{$video_details->attachment_fr}" target="_blank">
                                                    	{$video_details->attachment_fr}
                                                    </a> [<a href="{$baseurl}manage/videos/delete_attachment/{$video_details->trv_video_id}/fr">Delete</a>]
                                                    </div>
                                                {/if}
                                            {/if}
                                        </div>
...
<div class="container">
    ...
    {if isset($video_file_fr) && $video_file_fr!=NULL}
    	<a href="{$baseurl|replace:"administration/":""}assets/videos/{$video_file_fr}" target="_blank">
			{$video_file_fr}
		</a>
    {elseif $video_details!=NULL}
        {if $video_details->video_file_name_fr!=NULL}
            <div class="files">
            <a href="{$baseurl|replace:"administration/":""}assets/videos/{$video_details->video_file_name_fr}" target="_blank">
                {$video_details->video_file_name_fr}
            </a> [<a href="{$baseurl}manage/videos/delete_video/{$video_details->trv_video_id}/fr">Delete</a>]
            </div>
        {/if}
    {/if}
</div>
