<div id="hld">
	<div class="wrapper">		<!-- wrapper begins -->
		...
		{if isset($product_create_successfully) && $product_create_successfully!=NULL}
		...
		<table class="events-standard-table">
			<tr>
				...
				<td>
					<input type="text" name="event_name" id="event_name" class="text" value="{$event_details->event_name}" />
					{if isset($event_name_blank) &&  $event_name_blank!=NULL}
			...
			<tr>
				...
				<td>
					<input type="text" name="event_subtitle" id="event_subtitle" class="text" value="{$event_details->event_subtitle}" />
					{if isset($event_subtitle_blank) &&  $event_subtitle_blank!=NULL}
			...
			<tr>
				...
				<td>
					<textarea name="event_description" id="event_description" class="text textarea" >{$event_details->event_description}</textarea>
					{if isset($event_description_blank) &&  $event_description_blank!=NULL}
			...
			<tr>
				...
				<td>
					<input type="text" id="event_date" name="event_date" class="text" value="{$event_details->event_date}" />
					{if isset($event_date_blank) &&  $event_date_blank!=NULL}
			...
			<tr>
				<td></td>
				<td>                                   
					<button type="submit" name="add_event" id="add_event" value="submit" class="btn">Save</button>
				</td>
			</tr>
		</table>
		</form>
