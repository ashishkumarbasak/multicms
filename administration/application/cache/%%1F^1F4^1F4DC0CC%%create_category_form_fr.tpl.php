<?php /* Smarty version 2.6.19, created on 2013-06-01 13:16:40
         compiled from manage/categories/create_category_form_fr.tpl */ ?>
...
?>
						...
						<table cellpadding="0" cellspacing="0" width="100%" class="sortable margin">
							...
							<tbody>
								<tr>
									<td><label>Category Name (FR):</label></td>
									<td><input type="text" class="text small" name="category_name_fr" value="<?php if (isset ( $this->_tpl_vars['category_details'] ) && $this->_tpl_vars['category_details'] != NULL): ?><?php echo $this->_tpl_vars['category_details']->category_name_fr; ?>
<?php endif; ?>"/></td>
									<td><a href="#" class="tooltip-test" title="Tooltip"><i class="icon-info-sign"></i></a></td>
								</tr>
                                
                                <tr>
									<td><label>Description (FR):</label></td>
									<td><textarea name="category_description_fr" id="category_description" class="textarea"><?php if (isset ( $this->_tpl_vars['category_details'] ) && $this->_tpl_vars['category_details'] != NULL): ?><?php echo $this->_tpl_vars['category_details']->category_description_fr; ?>
<?php endif; ?></textarea></td>
									<td><a href="#" class="tooltip-test" title="Tooltip"><i class="icon-info-sign"></i></a></td>
								</tr>
                                
                                <tr>
									<td><label>Image (FR):</label></td>
									<td><input type="file" name="category_image_fr" id="category_image"></td>
									<td><a href="#" class="tooltip-test" title="Tooltip"><i class="icon-info-sign"></i></a></td>
								</tr>
