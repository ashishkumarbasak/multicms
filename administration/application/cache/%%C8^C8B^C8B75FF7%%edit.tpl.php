<?php /* Smarty version 2.6.19, created on 2013-08-24 19:06:34
         compiled from manage/user/edit.tpl */ ?>
<div id="hld">
		...
		<div class="block withsidebar">
				...
				<div class="block_content">
                    ...
                    <form action="" method="post">	
                    	<?php if (isset ( $this->_tpl_vars['user_updated_successfully'] )): ?>
						...
						<table cellpadding="0" cellspacing="0" width="100%" class="sortable margin">
							...
							<tbody>
								<tr>
									...
									<td><input type="text" class="text small" name="full_name" value="<?php echo $this->_tpl_vars['user_details']->display_name; ?>
" /></td>
								...
								<tr>
									...
									<td><input type="text" class="text small" name="signup_username" value="<?php echo $this->_tpl_vars['user_details']->username; ?>
"/></td>
									<td><a href="#" class="tooltip-test" title="Tooltip"><i class="icon-info-sign"></i></a></td>
								</tr>
								...
								<tr>
									...
									<td><input type="text" class="text small" name="email"  value="<?php echo $this->_tpl_vars['user_details']->email; ?>
"/></td>
									<td><a href="#" class="tooltip-test" title="Tooltip"><i class="icon-info-sign"></i></a></td>
								</tr>
...
">
                                        <input class="btn" type="submit" value="Submit" name="update_my_account">
                                    </td>
                                    <td></td>
								</tr>
							</tbody>
