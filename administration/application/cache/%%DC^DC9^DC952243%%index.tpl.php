<?php /* Smarty version 2.6.19, created on 2013-02-03 09:01:00
         compiled from manage/theme/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'manage/theme/index.tpl', 239, false),)), $this); ?>
<!DOCTYPE html>
<html>
<head>
...
manage/themes">Manage Hotel Themes</a></li>
</ul>
...
index.php/manage/themes/add_theme">Add New Themes </a> </p>     
...
'; ?>
            ...
            <div id="table1">
                <table class='dataTable'>
                    <thead>
                        <tr>
                            	<th class="align-left"><input type="checkbox" id="select_all" name="select_all" value="<?php echo count($this->_tpl_vars['themelist']); ?>
" onClick="toggle(this.value);"/></th>
                                <th class="align-left">Last Minute Theme</th>
                                <th>Action</th>
                        </tr>
                        </thead>
                        <tbody>
							<?php $_from = $this->_tpl_vars['themelist']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['listofthemes'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['listofthemes']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['tk'] => $this->_tpl_vars['theme']):
        $this->_foreach['listofthemes']['iteration']++;
?>
                            <tr class="gradeA">
                                	<td><input type="checkbox" id="checkbox_<?php echo $this->_tpl_vars['tk']; ?>
" name="checkbox_<?php echo $this->_tpl_vars['tk']; ?>
" value="<?php echo $this->_tpl_vars['theme']->lastminutetheme_id; ?>
" /></td>
                                    <td><?php echo $this->_tpl_vars['theme']->theme_name; ?>
</td>
                                    <td class="center"><a href="<?php echo $this->_tpl_vars['baseurl']; ?>
index.php/manage/themes/edit_themes/<?php echo $this->_tpl_vars['theme']->lastminutetheme_id; ?>
">Edit</a> &nbsp;|&nbsp; <a href="<?php echo $this->_tpl_vars['baseurl']; ?>
index.php/manage/themes/delete_themes/<?php echo $this->_tpl_vars['theme']->lastminutetheme_id; ?>
">Delete</a></td>
                            </tr>
