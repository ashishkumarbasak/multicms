<?php /* Smarty version 2.6.19, created on 2013-11-06 17:48:06
         compiled from manage/events/edit.tpl */ ?>
<div id="hld">
	<div class="wrapper">		<!-- wrapper begins -->
		...
		<table class="events-standard-table">
			<tr>
				...
				<td>
					<input type="text" name="event_name" id="event_name" class="text" value="<?php echo $this->_tpl_vars['event_details']->event_name; ?>
" />
			...
			<tr>
				...
				<td>
					<input type="text" name="event_subtitle" id="event_subtitle" class="text" value="<?php echo $this->_tpl_vars['event_details']->event_subtitle; ?>
" />
			...
			<tr>
				...
				<td>
					<textarea name="event_description" id="event_description" class="text textarea" ><?php echo $this->_tpl_vars['event_details']->event_description; ?>
</textarea>
			...
			<tr>
				...
				<td>
					<input type="text" id="event_date" name="event_date" class="text" value="<?php echo $this->_tpl_vars['event_details']->event_date; ?>
" />
