<?php /* Smarty version 2.6.19, created on 2013-02-16 03:40:04
         compiled from manage/service/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'manage/service/index.tpl', 241, false),)), $this); ?>
<!DOCTYPE html>
<html>
<head>
...
index.php/manage/services/add_service">Add New Services </a></button> </p>      
...
'; ?>
            ...
            <div id="table1">
                <table class='dataTable'>
                    <thead>
                        <tr>
                            	<th class="align-left"><input type="checkbox" id="select_all" name="select_all" value="<?php echo count($this->_tpl_vars['servicelist']); ?>
" onClick="toggle(this.value);"/></th>
                                <th class="align-left">Service Name</th>
                                <th>Action</th>
                        </tr> 
                        </thead>
                        <tbody>
							<?php $_from = $this->_tpl_vars['servicelist']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['listofservices'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['listofservices']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['sk'] => $this->_tpl_vars['service']):
        $this->_foreach['listofservices']['iteration']++;
?>
                            <tr class="gradeA">

                                	<td><input type="checkbox" id="checkbox_<?php echo $this->_tpl_vars['sk']; ?>
" name="checkbox_<?php echo $this->_tpl_vars['sk']; ?>
" value="<?php echo $this->_tpl_vars['service']->facility_id; ?>
" /></td>

                                    <td><?php echo $this->_tpl_vars['service']->facility_name; ?>
</td>

                                    <td class="center"><a href="<?php echo $this->_tpl_vars['baseurl']; ?>
index.php/manage/services/edit_service/<?php echo $this->_tpl_vars['service']->facility_id; ?>
">Edit</a> &nbsp;|&nbsp; <a href="<?php echo $this->_tpl_vars['baseurl']; ?>
index.php/manage/services/delete_services/<?php echo $this->_tpl_vars['service']->facility_id; ?>
">Delete</a></td>
