<?php /* Smarty version 2.6.19, created on 2013-02-03 09:01:06
         compiled from manage/theme/edit_theme.tpl */ ?>
<!DOCTYPE html>
<html>
<head>
...
index.php/manage/themes/update_themes>
            
            <label><?php  echo "Theme Name:";  ?>
                </label>

               <label> <input type="hidden" name="lastminutetheme_id" value="<?php if ($this->_tpl_vars['data'] != NULL): ?><?php echo $this->_tpl_vars['data']->lastminutetheme_id; ?>
<?php endif; ?>" >
               <label> <input type="text" name="theme_name" value="<?php if ($this->_tpl_vars['data'] != NULL): ?><?php echo $this->_tpl_vars['data']->theme_name; ?>
<?php endif; ?>" >
