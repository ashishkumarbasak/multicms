<?php /* Smarty version 2.6.19, created on 2013-08-21 21:14:32
         compiled from manage/pages/additional_photo.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'manage/pages/additional_photo.tpl', 29, false),)), $this); ?>
...
assets/js/jQuery-File-Upload/js/jquery.fileupload.js"></script>
                                                    ...
                                                    <div class="container">
                                                        ...
                                                        <span class="btn btn-success fileinput-button">
                                                            ...
                                                            <input id="additional_photo_<?php echo $this->_tpl_vars['field_details']->field_id; ?>
" type="file" name="files[]" multiple>
                                                            <input type="hidden" name="additional_filed_value_<?php echo $this->_tpl_vars['field_details']->field_id; ?>
" id="additional_photo_value_<?php echo $this->_tpl_vars['field_details']->field_id; ?>
" value="">
                                                        </span>
                                                        <br>
                                                        <br>
                                                        <!-- The global progress bar -->
                                                        <div id="progress_additional_photo_<?php echo $this->_tpl_vars['field_details']->field_id; ?>
" class="progress progress-success progress-striped">
                                                            <div class="bar"></div>
                                                        </div>
                                                        <div id="files_additional_photo_<?php echo $this->_tpl_vars['field_details']->field_id; ?>
" class="files">
...
<?php echo 'assets/pages/\'+file.name+\'">\'+file.name+\'</a>\';
               	var file_field_id = "#files_additional_photo_'; ?>
<?php echo $this->_tpl_vars['field_details']->field_id; ?>
<?php echo '";
				$(file_field_id).html("");
			    $(\'<p/>\').html(file_link).appendTo(file_field_id);
				$(\'#additional_photo_value_'; ?>
<?php echo $this->_tpl_vars['field_details']->field_id; ?>
