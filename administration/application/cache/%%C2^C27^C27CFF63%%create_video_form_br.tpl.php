<?php /* Smarty version 2.6.19, created on 2013-07-26 07:12:41
         compiled from manage/videos/create_video_form_br.tpl */ ?>
						...
						<table cellpadding="0" cellspacing="0" width="100%" class="sortable margin">
							...
							<tbody>
								<tr>
									...
									<td><input type="text" class="text small" name="video_title_br" value="<?php if ($this->_tpl_vars['video_details'] != NULL): ?><?php echo $this->_tpl_vars['video_details']->video_title_br; ?>
<?php endif; ?>" /></td>
								...
								<tr>
									...
									<td><textarea name="video_description_br" id="video_description" class="textarea"><?php if ($this->_tpl_vars['video_details'] != NULL): ?><?php echo $this->_tpl_vars['video_details']->video_description_br; ?>
