<?php /* Smarty version 2.6.19, created on 2013-11-07 06:17:29
         compiled from manage/news/index.tpl */ ?>
<?php echo '
<style type="text/css">
...
manage/news/edit/<?php echo $this->_tpl_vars['page']->page_id; ?>
...
manage/news/delete/<?php echo $this->_tpl_vars['page']->news_id; ?>
...
" style="width:30px;"></td>
                                            ...
                                            <td>
                                                <a class="btn btn-small" href="<?php echo $this->_tpl_vars['baseurl']; ?>
manage/news/edit/<?php echo $this->_tpl_vars['subpage']->page_id; ?>
">edit</a>
                                                <a class="btn btn-danger btn-small" href="<?php echo $this->_tpl_vars['baseurl']; ?>
manage/products/delete/<?php echo $this->_tpl_vars['subpage']->news_id; ?>
/<?php echo $this->_tpl_vars['subpage']->page_id; ?>
" onclick='return confirm("Are you sure you want to delete?")'>Delete</a>
                                            </td>
                                        </tr>
