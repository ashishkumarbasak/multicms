<?php /* Smarty version 2.6.19, created on 2013-02-26 04:24:09
         compiled from manage/payments/upload_invoice.tpl */ ?>
<!DOCTYPE html>
<html>
<head>
...
'; ?>
            ...
            <div id="table1">
               <form name="upload_bills" id="upload_bills" method="post" action="" enctype="multipart/form-data">
               <table>
               		<tr>
                    	<td>
                        	Hotel Name
                        ...
                        <td>
                        	<select name="user_id" id="user_id">
                            	<?php $_from = $this->_tpl_vars['all_hotels']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['listofusers'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['listofusers']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['uk'] => $this->_tpl_vars['hotel']):
        $this->_foreach['listofusers']['iteration']++;
?>
                                	<option value="<?php echo $this->_tpl_vars['hotel']->user_id; ?>
"><?php echo $this->_tpl_vars['hotel']->hotel_name; ?>
 (<?php echo $this->_tpl_vars['hotel']->username; ?>
)</option>
                    ...
                    <tr>
                        ...
                        <td>
                        	<input type="file" name="bills_file" id="bills_file" value="" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                        	<input type="hidden" name="invoice_number" id="invoice_number" value="<?php echo $this->_tpl_vars['invoice_details']->invoice_number; ?>
">
                            <input type="hidden" name="pk_invoice" id="pk_invoice" value="<?php echo $this->_tpl_vars['invoice_details']->pk_invoice; ?>
">
