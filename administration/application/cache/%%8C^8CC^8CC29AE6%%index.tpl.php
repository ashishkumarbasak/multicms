<?php /* Smarty version 2.6.19, created on 2012-02-11 16:08:50
         compiled from manage/matches/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'manage/matches/index.tpl', 233, false),array('modifier', 'date_format', 'manage/matches/index.tpl', 255, false),)), $this); ?>
<!DOCTYPE html>
<html>
<head>
...
manage/matches">Manage Matches</a></li>
</ul>
...
'; ?>
            ...
            <div id="table1">
                <table class='dataTable'>
                    <thead>
                        <tr>
                            	<th class="align-left"><input type="checkbox" id="select_all" name="select_all" value="<?php echo count($this->_tpl_vars['list_of_matches']); ?>
" onClick="toggle(this.value);"/></th>
                                <th class="align-left">Home Team</th>
                                <th class="align-left">Guest Team</th>
                                <th class="align-left">Match Status</th>
                        ...
                        <tbody>
							<?php $_from = $this->_tpl_vars['list_of_matches']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['listofmatches'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['listofmatches']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['mk'] => $this->_tpl_vars['match']):
        $this->_foreach['listofmatches']['iteration']++;
?>
                            <tr class="gradeA">
                                	<td><input type="checkbox" id="checkbox_<?php echo $this->_tpl_vars['mk']; ?>
" name="checkbox_<?php echo $this->_tpl_vars['mk']; ?>
" value="<?php echo $this->_tpl_vars['match']->match_id; ?>
" /></td>
                                    <td><?php echo $this->_tpl_vars['match']->home_team; ?>
</td>
                                    <td><?php echo $this->_tpl_vars['match']->guest_team; ?>
</td>
									<td>Is Finished: <?php echo $this->_tpl_vars['match']->is_finished; ?>
</td>
                                   <td><?php echo $this->_tpl_vars['match']->m_total_comment; ?>
</td>
									<td><?php echo $this->_tpl_vars['match']->m_total_flag; ?>
</td>
									<td><?php echo $this->_tpl_vars['match']->m_total_like; ?>
</td>
									<td><?php echo ((is_array($_tmp=$this->_tpl_vars['match']->created_on)) ? $this->_run_mod_handler('date_format', true, $_tmp) : smarty_modifier_date_format($_tmp)); ?>
</td>
									<td><?php echo $this->_tpl_vars['match']->username; ?>
</td>
