<?php /* Smarty version 2.6.19, created on 2014-01-09 15:01:30
         compiled from manage/clients/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'manage/clients/index.tpl', 33, false),)), $this); ?>
<div id="hld">
...
manage/clients/edit/<?php echo $this->_tpl_vars['user']->user_id; ?>
...
manage/clients/block/<?php echo $this->_tpl_vars['user']->user_id; ?>
" onclick='return confirm("Are you sure you want to block?")'>Block</a>
                                        <?php else: ?>
                                        	<a class="btn btn-danger btn-small" href="<?php echo $this->_tpl_vars['baseurl']; ?>
manage/clients/unblock/<?php echo $this->_tpl_vars['user']->user_id; ?>
">Unblock</a>
                                        <?php endif; ?>
                                        <a class="btn btn-danger btn-small" href="<?php echo $this->_tpl_vars['baseurl']; ?>
manage/clients/delete/<?php echo $this->_tpl_vars['user']->user_id; ?>
