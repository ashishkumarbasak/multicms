<?php /* Smarty version 2.6.19, created on 2013-02-16 12:39:40
         compiled from manage/payments/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'manage/payments/index.tpl', 233, false),array('modifier', 'replace', 'manage/payments/index.tpl', 254, false),)), $this); ?>
<!DOCTYPE html>
<html>
<head>
...
'; ?>
            ...
            <div id="table1">
                <table class='dataTable'>
                    <thead>
                        <tr>
                            	<th class="align-left"><input type="checkbox" id="select_all" name="select_all" value="<?php echo count($this->_tpl_vars['list_of_payments']); ?>
" onClick="toggle(this.value);"/></th>
                                <th class="align-left">Hotel name</th>
                                <th class="align-left">Invoice Number</th>
                                <th class="align-left">Payment Through</th>
                        ...
                        <tbody>
							<?php $_from = $this->_tpl_vars['list_of_payments']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['listofpayments'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['listofpayments']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['uk'] => $this->_tpl_vars['payment']):
        $this->_foreach['listofpayments']['iteration']++;
?>
                            <tr class="gradeA">
                                	<td><input type="checkbox" id="checkbox_<?php echo $this->_tpl_vars['uk']; ?>
" name="checkbox_<?php echo $this->_tpl_vars['uk']; ?>
" value="<?php echo $this->_tpl_vars['payment']->invoice_number; ?>
" /></td>
                                    <th><?php echo $this->_tpl_vars['payment']->hotel_name; ?>
</th>
                                    <td><?php echo $this->_tpl_vars['payment']->invoice_number; ?>
</td>
                                    <td><?php echo $this->_tpl_vars['payment']->payment_through; ?>
</td>
                                    <td><?php echo $this->_tpl_vars['payment']->total_amount; ?>
 &euro;</td>
                                    <td><?php echo $this->_tpl_vars['payment']->payment_status; ?>
</td>
                                    <td class="center">
                                    	<a href="<?php echo $this->_tpl_vars['baseurl']; ?>
index.php/manage/payments/invoice/<?php echo $this->_tpl_vars['payment']->invoice_number; ?>
">Upload Invoice</a> 
                                        <?php if ($this->_tpl_vars['payment']->invoice_attachment != NULL): ?>
...
assets/bills/<?php echo $this->_tpl_vars['payment']->user_id; ?>
/<?php echo $this->_tpl_vars['payment']->invoice_attachment; ?>
">Download Invoice</a> 
                                        <?php endif; ?>
                                    </td>
                            </tr>
