<?php /* Smarty version 2.6.19, created on 2013-03-11 21:10:00
         compiled from manage/period/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'manage/period/index.tpl', 239, false),)), $this); ?>
<!DOCTYPE html>
<html>
<head>
...
manage/themes">Manage Offer Period List</a></li>
</ul>
...
<div class="grid_16 widget tabs first">
        ...
        <!-- Add new Offer period -->
        <p align=center> <a href="<?php echo $this->_tpl_vars['baseurl']; ?>
index.php/manage/periods/add_offerperiod">New Offer period </a></button> </p>     
...
'; ?>
            ...
            <div id="table1">
                <table class='dataTable'>
                    <thead>
                        <tr>
                            	<th class="align-left"><input type="checkbox" id="select_all" name="select_all" value="<?php echo count($this->_tpl_vars['periodlist']); ?>
" onClick="toggle(this.value);"/></th>
                                <th class="align-left">Periods</th>
                                <th>Action</th>
                        </tr>
                        </thead>
                        <tbody>
							<?php $_from = $this->_tpl_vars['periodlist']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['listofperiods'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['listofperiods']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['pk'] => $this->_tpl_vars['period']):
        $this->_foreach['listofperiods']['iteration']++;
?>
                            <tr class="gradeA">
                                <td><input type="checkbox" id="checkbox_<?php echo $this->_tpl_vars['pk']; ?>
" name="checkbox_<?php echo $this->_tpl_vars['pk']; ?>
" value="<?php echo $this->_tpl_vars['period']->period_id; ?>
" /></td>
                                <td><?php echo $this->_tpl_vars['period']->period_name; ?>
</td>
                                <td class="center"><a href="<?php echo $this->_tpl_vars['baseurl']; ?>
index.php/manage/periods/edit_offerperiod/<?php echo $this->_tpl_vars['period']->period_id; ?>
">Edit</a> &nbsp;|&nbsp; 
                                <a href="<?php echo $this->_tpl_vars['baseurl']; ?>
index.php/manage/periods/delete_offerperiod/<?php echo $this->_tpl_vars['period']->period_id; ?>
">Delete</a></td>
                            </tr>
