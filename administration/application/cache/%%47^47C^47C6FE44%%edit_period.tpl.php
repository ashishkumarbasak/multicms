<?php /* Smarty version 2.6.19, created on 2013-03-11 21:10:06
         compiled from manage/period/edit_period.tpl */ ?>
<!DOCTYPE html>
<html>
<head>
...
index.php/manage/periods/update_offerperiod>
                <label>
                    Period Name: </label>
                <label> <input type="text" name="period_name" value="<?php if ($this->_tpl_vars['data'] != NULL): ?><?php echo $this->_tpl_vars['data']->period_name; ?>
<?php endif; ?>" >
               <label> <input type="hidden"  name="period_id" value="<?php if ($this->_tpl_vars['data'] != NULL): ?><?php echo $this->_tpl_vars['data']->period_id; ?>
<?php endif; ?>" >
