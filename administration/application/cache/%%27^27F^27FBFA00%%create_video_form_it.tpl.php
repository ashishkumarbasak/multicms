<?php /* Smarty version 2.6.19, created on 2013-07-26 07:12:41
         compiled from manage/videos/create_video_form_it.tpl */ ?>
                        ...
                        <?php if (isset ( $this->_tpl_vars['video_updated_successfully'] )): ?>
                        	<div class="message info">
                            <p>
...
?>
                                	<?php if ($this->_tpl_vars['error'] == 'video_title_it_blank'): ?> Video Title (IT) can't be left blank.<br><?php endif; ?>
                                    <?php if ($this->_tpl_vars['error'] == 'video_description_it_blank'): ?> Video Description (IT) can't be left blank.<br><?php endif; ?>
						...
						<table cellpadding="0" cellspacing="0" width="100%" class="sortable margin">
							...
							<tbody>
								<tr>
									...
									<td><input type="text" class="text small" name="video_title_it" value="<?php if ($this->_tpl_vars['video_details'] != NULL): ?><?php echo $this->_tpl_vars['video_details']->video_title_it; ?>
<?php endif; ?>" /></td>
								...
								<tr>
									...
									<td><textarea name="video_description_it" id="video_description" class="textarea"><?php if ($this->_tpl_vars['video_details'] != NULL): ?><?php echo $this->_tpl_vars['video_details']->video_description_it; ?>
...
" <?php if ($this->_tpl_vars['video_details'] != NULL && $this->_tpl_vars['video_details']->video_category_id == $this->_tpl_vars['category']->category_id): ?> selected="selected" <?php endif; ?>>
