<?php /* Smarty version 2.6.19, created on 2013-02-12 14:16:39
         compiled from manage/offer/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'manage/offer/index.tpl', 240, false),)), $this); ?>
<!DOCTYPE html>
<html>
<head>
...
index.php/dashboard"><?php echo $this->_tpl_vars['profile_details']->username; ?>
</a></strong>
                        <ul class="piped">
                            <li><a href="<?php echo $this->_tpl_vars['baseurl']; ?>
index.php/dashboard">My Account</a></li>
                            <li><a href="<?php echo $this->_tpl_vars['baseurl']; ?>
index.php/user/logout">Logout</a></li>
                        </ul>
                    </div>
...
manage/user">Manage Offers</a></li>
</ul>
...
<!-- Add new Offer -->
        <p align=center> <a href="<?php echo $this->_tpl_vars['baseurl']; ?>
index.php/manage/offers/add_offer">New Offer </a></p> 
...
'; ?>
            ...
            <div id="table1">
                <table class='dataTable'>
                    <thead>
                        <tr>
                            	<th class="align-left"><input type="checkbox" id="select_all" name="select_all" value="<?php echo count($this->_tpl_vars['Offerlist']); ?>
" onClick="toggle(this.value);"/></th>
                                <th class="align-left">Offer Title</th>
                                <th class="align-left">Status</th>
                                <th>Action</th>
                        </tr>
                        </thead>
                        <tbody>
							<?php $_from = $this->_tpl_vars['Offerlist']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['listofoffers'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['listofoffers']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['ok'] => $this->_tpl_vars['Offer']):
        $this->_foreach['listofoffers']['iteration']++;
?>
                            <tr class="gradeA">
                                	<td><input type="checkbox" id="checkbox_<?php echo $this->_tpl_vars['ok']; ?>
" name="checkbox_<?php echo $this->_tpl_vars['ok']; ?>
" value="<?php echo $this->_tpl_vars['Offer']->offer_id; ?>
" /></td>
                                    <td><?php echo $this->_tpl_vars['Offer']->offer_title; ?>
</td>
                                    <td><?php if ($this->_tpl_vars['Offer']->offer_status == '1'): ?>Active<?php else: ?>Inactive<?php endif; ?></td>
									<td class="center"><a href="">Edit</a> &nbsp;|&nbsp; <a href="<?php echo $this->_tpl_vars['baseurl']; ?>
index.php/manage/offers/delete/<?php echo $this->_tpl_vars['Offer']->offer_id; ?>
" onClick="return confirm('Are you sure that you want to delete this offer?');">Delete</a></td>
                            </tr>
