<?php /* Smarty version 2.6.19, created on 2013-11-28 20:30:52
         compiled from manage/packagings/edit.tpl */ ?>
		...
		<div class="block">
			<div class="block_content">
				<h1>Edit Packaging</h1>
                		<?php if (isset ( $this->_tpl_vars['package_update_successfully'] )): ?>
...
<?php else: ?><?php echo $this->_tpl_vars['packaging_details']->pack_title; ?>
<?php endif; ?>" />
                                </td>
                            </tr>
                            <tr>
...
<?php else: ?><?php echo $this->_tpl_vars['packaging_details']->pack_code; ?>
<?php endif; ?>" />
                                </td>
                            </tr>
                        </table>    
...
<?php else: ?><?php echo $this->_tpl_vars['packaging_details']->pack_description; ?>
<?php endif; ?></textarea>
