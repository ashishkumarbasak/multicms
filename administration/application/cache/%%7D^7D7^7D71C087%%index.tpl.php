<?php /* Smarty version 2.6.19, created on 2012-12-09 19:07:11
         compiled from manage/bills/index.tpl */ ?>
<!DOCTYPE html>
<html>
<head>
...
'; ?>
            ...
            <div id="table1">
               <form name="upload_bills" id="upload_bills" method="post" action="<?php echo $this->_tpl_vars['baseurl']; ?>
index.php/manage/user/bills" enctype="multipart/form-data">
               <table>
               		<tr>
                    	<td>
                        	Hotel Name
