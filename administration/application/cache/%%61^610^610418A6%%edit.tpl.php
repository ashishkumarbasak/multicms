<?php /* Smarty version 2.6.19, created on 2013-09-24 16:28:11
         compiled from manage/news/edit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'manage/news/edit.tpl', 111, false),array('modifier', 'count', 'manage/news/edit.tpl', 240, false),array('modifier', 'in_array', 'manage/news/edit.tpl', 294, false),)), $this); ?>
...
.png" style="border:0px; padding-top:3px;"></label></td>
								<td>
                                	<input name="page_title" type="text" id="page_title" class="text small" value="<?php if (isset ( $this->_tpl_vars['page_title'] )): ?><?php echo $this->_tpl_vars['page_title']; ?>
...
.png" style="border:0px; padding-top:3px;"></label></td>
								<td>
                                	<input type="text" name="page_url" id="page_url" style="text-transform: lowercase;" class="text small" value="<?php if (isset ( $this->_tpl_vars['page_url'] )): ?><?php echo $this->_tpl_vars['page_url']; ?>
...
" target="_blank">
                                                                    ...
                                                                    </div><br><code>&lt; php echo image_1 &gt;</code>
                                                                <?php endif; ?>
                                                            <?php endif; ?>
